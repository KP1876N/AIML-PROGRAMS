...
Xtr,Xte,Ytr,Yte = train_test_split(
    X,Y,test_size=.25,random_state=0,stratify=Y
)
...
sns.heatmap(confusion_matrix(Yte,p),annot=True,fmt="d",
            xticklabels=e.classes_,yticklabels=e.classes_)
...
plot_tree(m.estimators_[0],feature_names=X.columns,
          class_names=e.classes_,filled=True,rounded=True,fontsize=8)
